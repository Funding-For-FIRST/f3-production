...
function setOptions(apiPaths) {
    const options = {
        definition: {
          openapi: "3.1.0",
          info: {
            title: "Funding for First Express API",
            version: "0.1.0",
            description: "This is a crappy API tester currently (read: permanently cause I'm lazy) hosted by swagger.",
            contact: {
              name: "Complaint Department",
              email: "oscarthegrouch@trashcan.com",
            },
          },
          servers: [
            {
              url: "http://localhost:5000/test-project-73eaa/us-central1/api",
            },
          ],
        },
...
function initializeSwaggerUI(app, swaggerRoute, apiPaths) {
    //if((app instanceof Express)) { throw 'Invalid API Application'; }
